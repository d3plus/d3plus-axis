...
```sh
git clone git@github.com:your-username/d3plus-axis.git
```
...
```sh
https://d3plus.org/examples/d3plus-axis/my-cool-example/
```
...
Push to your fork and [submit a pull request](https://github.com/d3plus/d3plus-axis/compare/). At this point, you're waiting on us. We may suggest some changes or improvements or alternatives.
